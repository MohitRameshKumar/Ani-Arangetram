...
const CONTENT = {
  ...
  artists: [
    ...
    },
    {
      ...
      bio: "Vidwan and Guru Dr. Shiv Kumar Bhat is a distinguished Carnatic vocalist, revered guru, Vedic scholar, composer, and Harikatha exponent. Raised in a family of Vedic scholars in Karnataka, he embodies the rich spiritual heritage that has long nurtured India's classical arts.\n\nA senior disciple of Sangeetha Kalanidhi Shri Neyveli Santhanagopalan, Dr. Bhat also underwent training under Padma Bhushan Sangeetha Kalanidhi Shri B. Rajam Iyer, from whom he learned numerous rare compositions, including Rama Nataka Kritis, rare Dikshitar Kritis, and Tiruppavais.\n\nAs a performer, he has presented concerts at prestigious sabhas, festivals, and cultural organizations across India and the United States. He has been featured during Chennai's renowned Margazhi Music Season and is a graded artist of All India Radio.\n\nBeyond the concert stage, Dr. Bhat is a highly respected Harikatha exponent who beautifully blends music, philosophy, and storytelling, making India's timeless scriptures and epics accessible to contemporary audiences. As a teacher, he has mentored numerous students in India and the United States, many of whom are accomplished performers today.\n\nDr. Bhat earned his Ph.D. in Sanskrit from the University of Mysore and is widely respected throughout the Great Lakes region and the San Francisco Bay Area for his dedicated service as a musician, teacher, and Vedic scholar. His contributions to music education have been recognized with several prestigious honors, including the Best Teacher Award at the Cleveland Thyagaraja Festival, Sangeetha Ratna from the Madras Music Academy, Sangeetha Kala-Shreshta from South India Fine Arts, and the Parampara Rakshak Award from the VVS Foundation.",
    },
    {
      name: "Vidwan VV Ravi",
      instrument: "Violin",
